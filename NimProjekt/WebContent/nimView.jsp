...
<meta name="description" content="Nim Spiel">
<meta name="author" content="Bernd BEhrensdorf">
...
<script src="https://use.fontawesome.com/2d3f7bba0d.js"></script>
...
<body>
 ...
 -->
	...
	<div class="container">
		<h1>Nim Spiel</h1>
		<p>
			Klicke auf einen Stein in einer beliebigen Reihe. Er und alle Steine
		...
		<div class="container">
			<div class="nimview well">
				<table id="nimtable" class="nim-field">
					<%
						// Zweites hässliches Scriptlet
				...
				<div>
					<button type="button" id="btnBack" class="btn btn-primary nimbtn">zurück
